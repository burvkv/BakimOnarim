    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MalzemeID = table.Column<long>(type: "bigint", nullable: false)
                    ...
                    BirimFiyat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Adet = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBL_Malzeme", x => x.MalzemeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GrupID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AracSinifID = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TBL_VGrupGrupID = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBL_Varlik", x => x.VarlikID);
                    table.ForeignKey(
                        name: "FK_TBL_Varlik_TBL_VGrup_TBL_VGrupGrupID",
                        column: x => x.TBL_VGrupGrupID,
                        principalTable: "TBL_VGrup",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TBL_Varlik_TBL_VGrupGrupID",
                table: "TBL_Varlik",
                column: "TBL_VGrupGrupID");
        }
